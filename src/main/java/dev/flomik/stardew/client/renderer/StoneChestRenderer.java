...
public class StoneChestRenderer<T extends BlockEntityStoneChest> extends ChestRenderer<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(StardewMod.MODID, "stone_chest"), "main");

    private static final ResourceLocation[] TEXTURES = new ResourceLocation[21];
    static {
        for (int i = 0; i < 21; i++) {
            TEXTURES[i] = new ResourceLocation(StardewMod.MODID, "textures/block/craftables/stone_chest/stone_chest_" + i + ".png");
        }
    }
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        partdefinition.addOrReplaceChild("bottom", CubeListBuilder.create()
                        .texOffs(0, 0).addBox(1.0F, 0.0F, 1.0F, 14.0F, 10.0F, 14.0F),
                PartPose.ZERO);
        ...
        PartDefinition lid = partdefinition.addOrReplaceChild("lid", CubeListBuilder.create()
                ...
                PartPose.offset(0.0F, 10, 15.0F));

        lid.addOrReplaceChild("lock", CubeListBuilder.create()
                        .texOffs(0, 42).addBox(6.0F, -3.0F, -15.0F, 4.0F, 4.0F, 1.0F),
