...
SOURCE = "big_stone_chest/big_stone_chest_uncolored.png"   # что перекрашиваем
TARGET = "big_stone_chest/target.png"   # откуда берём оттенки
OUTPUT = "big_stone_chest/big_chest_recolored.png"
